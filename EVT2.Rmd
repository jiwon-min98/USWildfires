...
overthreshold_glm <- glm(formula = overthreshold ~ CNT + month + year + lat + thermal_rad + altiSD + solar_rad +  wind +altiMean + lc18 + lc1 + lc7 + lc8 +lc15 + lc5 + lc12, family = binomial, data = train_data)
